    ...
    def list_calls(business=None, start_date=None, end_date=None, limit=10000):
        ...
        if business is not None:
            ...
            if not agents.exists():
                print(f"No Retell agents found for business {business.id}")
                return []
            ...
            if not agent_ids:
                print(f"No valid agent IDs found for business {business.id}")
                return []
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"Error retrieving calls from Retell API: {response.text}")
                return []
                
        except requests.exceptions.RequestException as e:
            print(f"Request exception when calling Retell API: {str(e)}")
            return []
